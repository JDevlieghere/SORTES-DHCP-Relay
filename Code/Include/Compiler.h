...
#if defined(__18CXX) || defined(HI_TECH_C)|| defined (__SDCC__)	
    // All PIC18 processors
    #if defined(HI_TECH_C) && defined(__PICC18__)   // HI TECH PICC-18 compiler
	#define __18CXX
	#include <htc.h>

    #elif  defined(__SDCC__)                    //sdcc compiler
// the following lines are useless: pic18f97j60 is defined on the command line
//        #if defined (__18F97J60)  //similar entries should be added for other
//            #define pic18f97j60   //processors
//        #endif
	#define __18CXX         // __18CXX sometimes just means "any pic18"
        #include <pic18fregs.h> // this is sdcc specific
...
//ce qui suit, je ne sais pas: à voir
// Definitions that apply to all except Microchip MPLAB C Compiler for PIC18 MCUs (formerly C18)
#if (!defined(__18CXX) && !defined (__SDCC__)) || (defined(HI_TECH_C) && defined(__PICC18__))
...
// (PIC18)
	...
	// SDCC specific defines
	    ...
	    #define ROM                 	const
	    #define rom
            //Nop(),ClrWdt() and Reset() are defined in <pic18fregs.h>
	#endif
