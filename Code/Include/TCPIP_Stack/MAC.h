...
//MLPHYREG	ReadPHYReg(BYTE Register);
WORD	ReadPHYReg(BYTE Register);
//ML void	SetRXHashTableEntry(MAC_ADDR DestMACAddr);
void	SetRXHashTableEntry(MAC_ADDR* DestMACAddr); //ML
...
#if defined(__18CXX)
//ML	void MACPutROMArray(ROM BYTE *val, WORD len);
#else
