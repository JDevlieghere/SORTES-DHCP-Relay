...
/*	// Stores the data for an MPFS2 FAT record
	typedef struct
	{
//ML		DWORD string;		// Pointer to the file name
//ML		DWORD data;			// Address of the file data
//ML		DWORD len;			// Length of file data
//ML		DWORD timestamp;	// Timestamp of file
//ML		DWORD microtime;	// Microtime stamp of file
//ML		WORD flags;			// Flags for this file
		unsigned long string;		// Pointer to the file name
		unsigned long data;		// Address of the file data
		unsigned long len;		// Length of file data
		unsigned long timestamp;	// Timestamp of file
	        unsigned long microtime;	// Microtime stamp of file
		unsigned flags;			// Flags for this file
		} MPFS_FAT_RECORD;*/
