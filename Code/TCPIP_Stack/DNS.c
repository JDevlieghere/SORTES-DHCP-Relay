...
//ML#if defined(__18CXX)
//ML	static void DNSPutROMString(ROM BYTE* String);
//ML#else
...
//ML				DNSPutROMString(DNSHostNameROM);
				DNSPutString("Sorry");
...
static void DNSPutString(BYTE* String)
{
	...
	while(1)
	{
		...
		{
			i = *RightPtr++;
		} while((i != 0x00u) && (i != (int)'.') && (i != (int)'/') && (i != (int)',') && (i != (int)'>'));
